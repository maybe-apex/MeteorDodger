...
def main_game():
    ...
    # Laser timer
    if pygame.time.get_ticks()-laser_timer >= 400:
        laser_active = True
...
game_font = pygame.font.Font('font1.ttf', 40)
score = 0
laser_timer = 0
laser_active = False
